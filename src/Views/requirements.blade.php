...
{{ trans('service::message.requirements.templateTitle') }}
@endsection

@section('title')
<i class="fa fa-list-ul fa-fw" aria-hidden="true"></i>
{{ trans('service::message.requirements.title') }}
@endsection
...
<div class="buttons">
    <a class="button" href="{{ route('service::permissions') }}">
        {{ trans('service::message.requirements.next') }}
